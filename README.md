...
The primary objective is to transform raw pathology laboratory data into meaningful analytical findings that can support better understanding of patient patterns, test utilization, laboratory operations, diagnostic outcomes, revenue performance, and commercial activities.
...
The analysis calculates the turnaround time in hours between the **test date** and the **report date** for laboratory test records. The TAT values provide an operational view of how quickly test reports are generated.
...
The laboratory dataset contains **9,320 completed records**, while **1,171 records are pending**, **895 are in progress**, and **614 are cancelled**.
...
The analysis shows that result statuses vary across diagnostic tests, with **Completed** records generally representing the largest share of records for the tests shown. For example, **Calcium (Serum)** had 317 completed records, while **Blood Sugar Fasting (FBS)** had 315 completed records among the displayed test results.
...
The average patient age was relatively similar across most result statuses, ranging from **46.20 years for Cancelled records** to **48.94 years for In Progress records**. The age range for all result statuses was **1 to 90 years**.
...
The test-level revenue figures show that revenue is influenced by factors beyond test price, such as **the volume of tests performed**.

For example, **Blood Sugar Fasting (FBS)** generated approximately **11.34 million** in revenue despite having a test price of only **120**. In comparison, **CBC** generated approximately **5.48 million** at a price of **350**, while **Cholesterol Total** generated approximately **5.20 million** at a price of **300**.
...
- **Transasia Bio-Medicals** generated the highest sales revenue among the companies, with approximately **6.82 million** in revenue.

- **Beckman Coulter** and **Tulip Diagnostics** were also major contributors to company-wise sales revenue, generating approximately **6.76 million** and **6.63 million**, respectively.

- **TIBC Reagent Kit** generated the highest product-wise revenue, with approximately **6.33 million** in sales.

- **Iron (Fe) Reagent Kit** and **KFT Panel Reagent Kit** were the next highest-revenue-generating products, with approximately **6.19 million** and **5.66 million**, respectively.

- **Blood Sugar Fasting (FBS)** generated the highest revenue among the diagnostic tests shown, with approximately **11.34 million**, despite having a test price of **120**.

- **CBC** generated approximately **5.48 million** in revenue at a test price of **350**, while **Cholesterol Total** generated approximately **5.20 million** at a price of **300**.
...
Monthly patient registrations fluctuated throughout the analysis period. The highest monthly patient registration was **67**, recorded in **December 2024** and **November 2025**. The lowest monthly registration was **34**, recorded in **September 2026**.
...
The annual billing amount remained relatively stable from **2022 to 2025**, ranging from approximately **1.02 million to 1.05 million**. The highest annual billing amount among the complete years was recorded in **2025**, at approximately **1.05 million**.
...
- The lowest monthly patient registration was **34**, recorded in **September 2026**.
...
The analysis compares the number of tests performed with the revenue generated by each diagnostic test. The results show that higher test volume does not always correspond directly to higher revenue. For example, **Blood Sugar Fasting (FBS)** generated approximately **11.34 million** in revenue with **390 test records**, while **Cholesterol Total** generated approximately **5.20 million** with **119 test records**.

This indicates that revenue is influenced by both **test volume and the revenue generated per test**, rather than test volume alone.
...
The available TAT data contains turnaround time values for **Completed** records only. Completed records had an average turnaround time of approximately **1.50 hours**, with a median of **1 hour** and a maximum of **3 hours**.

TAT values were not available for **Cancelled, In Progress, and Pending** records in the analyzed dataset, resulting in missing statistical values for these statuses.

| Result Status | Count | Average TAT (Hours) | Median TAT (Hours) | Maximum TAT (Hours) |
|---|---:|---:|---:|---:|
| Cancelled | 0 | — | — | — |
| Completed | 9,320 | 1.50 | 1.00 | 3.00 |
| In Progress | 0 | — | — | — |
| Pending | 0 | — | — | — |
...
The analysis compares patient age with the number of laboratory tests performed for each patient. The sample shows variation in test frequency across different age groups. For example, patients aged **30 and 9 years** had **6 and 7 tests**, respectively, while patients aged **86 and 85 years** had **3 and 2 tests**.
...
- **Test volume and test price** both contribute to revenue variation.
...
- Monitor high-volume tests for better resource planning.
- Track department-wise turnaround time to identify operational variations.
- Monitor pending and in-progress test records.
- Evaluate discount patterns across diagnostic tests.
- Analyze test volume together with revenue for better commercial planning.
